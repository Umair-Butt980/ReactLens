...
Let's trace through a component's complete lifecycle from birth to death...`,
    ...
    state: {
      ...
      output: [
        { id: 'msg-1', type: 'info', message: 'Component lifecycle has 3 phases: Mount → Update → Unmount' },
...
The component function is "pure" during render - it should only compute JSX based on props and state, with no side effects.`,
    ...
    state: {
      ...
      timeline: [
        { id: 'event-1', phase: 'mount', stage: 'initial-render', description: 'Component function called', timestamp: Date.now(), isActive: true, category: 'render' },
      ],
      dom: [],
      activePhaseSegment: 'mount',
      output: [
...
This separation of render (what to show) and commit (actually showing it) is key to React's architecture. Rendering is interruptible and can be discarded. Commits are synchronous and final.`,
    ...
    state: {
      component: {
        ...
        props: [{ id: 'userId', name: 'userId', value: '123', hasChanged: false }],
        effects: [
          { id: 'effect-1', name: 'fetchEffect', dependencies: ['userId'], hasCleanup: true, status: 'pending', runCount: 0 },
          { id: 'effect-2', name: 'titleEffect', dependencies: ['user'], hasCleanup: true, status: 'pending', runCount: 0 },
        ],
        renderCount: 1,
        isMounted: false,
        isHighlighted: true,
      ...
      timeline: [
        { id: 'event-1', phase: 'mount', stage: 'initial-render', description: 'Component function called', timestamp: Date.now() - 100, isActive: false, category: 'render' },
        { id: 'event-2', phase: 'mount', stage: 'execute-render', description: 'JSX returned (loading state)', timestamp: Date.now(), isActive: true, category: 'render' },
      ],
      dom: [],
      activePhaseSegment: 'mount',
      output: [
...
This is different from useLayoutEffect, which runs synchronously BEFORE paint (rarely needed).`,
    ...
    state: {
      ...
      timeline: [
        { id: 'event-1', phase: 'mount', stage: 'initial-render', description: 'Component function called', timestamp: Date.now() - 200, isActive: false, category: 'render' },
        { id: 'event-2', phase: 'mount', stage: 'execute-render', description: 'JSX returned', timestamp: Date.now() - 100, isActive: false, category: 'render' },
        { id: 'event-3', phase: 'mount', stage: 'commit-dom', description: 'DOM nodes created and inserted', timestamp: Date.now(), isActive: true, category: 'commit' },
      ],
      dom: [
        { id: 'dom-1', tagName: 'div', content: 'Loading...', isNew: true, isUpdated: false, isRemoved: false },
      ],
      activePhaseSegment: 'mount',
      output: [
...
This is the pattern for subscriptions, timers, and event listeners - set up in effect, tear down in cleanup.`,
    ...
    state: {
      component: {
        ...
        props: [{ id: 'userId', name: 'userId', value: '123', hasChanged: false }],
        effects: [
          { id: 'effect-1', name: 'fetchEffect', dependencies: ['userId'], hasCleanup: true, status: 'running', runCount: 1 },
          { id: 'effect-2', name: 'titleEffect', dependencies: ['user'], hasCleanup: true, status: 'complete', runCount: 1 },
        ],
        renderCount: 1,
        isMounted: true,
        isHighlighted: true,
      ...
      timeline: [
        { id: 'event-1', phase: 'mount', stage: 'initial-render', description: 'Component function called', timestamp: Date.now() - 300, isActive: false, category: 'render' },
        { id: 'event-2', phase: 'mount', stage: 'execute-render', description: 'JSX returned', timestamp: Date.now() - 200, isActive: false, category: 'render' },
        { id: 'event-3', phase: 'mount', stage: 'commit-dom', description: 'DOM nodes created', timestamp: Date.now() - 100, isActive: false, category: 'commit' },
        { id: 'event-4', phase: 'mount', stage: 'run-effects', description: 'Effects executing', timestamp: Date.now(), isActive: true, category: 'effect' },
      ],
      dom: [
        { id: 'dom-1', tagName: 'div', content: 'Loading...', isNew: false, isUpdated: false, isRemoved: false },
      ],
      activePhaseSegment: 'mount',
      output: [
...
renderCount.current is now 2 - the ref persists across renders but doesn't trigger re-renders when mutated.`,
    ...
    state: {
      component: {
        ...
        state: [
          { id: 'user', name: 'user', value: '{ name: "Alice", id: 123 }', previousValue: 'null', hasChanged: true },
          { id: 'loading', name: 'loading', value: 'false', previousValue: 'true', hasChanged: true },
        ],
        props: [{ id: 'userId', name: 'userId', value: '123', hasChanged: false }],
        effects: [
          { id: 'effect-1', name: 'fetchEffect', dependencies: ['userId'], hasCleanup: true, status: 'complete', runCount: 1 },
          { id: 'effect-2', name: 'titleEffect', dependencies: ['user'], hasCleanup: true, status: 'pending', runCount: 1 },
        ],
        renderCount: 2,
        isMounted: true,
        isHighlighted: true,
      ...
      timeline: [
        { id: 'event-1', phase: 'mount', stage: 'mount-complete', description: 'Mount complete', timestamp: Date.now() - 500, isActive: false, category: 'effect' },
        { id: 'event-5', phase: 'update', stage: 'trigger', description: 'State update: user, loading', timestamp: Date.now(), isActive: true, category: 'render' },
      ],
      dom: [
        { id: 'dom-1', tagName: 'div', content: 'Loading...', isNew: false, isUpdated: false, isRemoved: false },
      ],
...
After commit, user sees "Alice" on screen. Now effects need to run...`,
    ...
    state: {
      ...
      timeline: [
        { id: 'event-5', phase: 'update', stage: 'trigger', description: 'State update triggered', timestamp: Date.now() - 200, isActive: false, category: 'render' },
        { id: 'event-6', phase: 'update', stage: 'execute-render', description: 'Re-render executed', timestamp: Date.now() - 100, isActive: false, category: 'render' },
        { id: 'event-7', phase: 'update', stage: 'commit-dom', description: 'DOM updated', timestamp: Date.now(), isActive: true, category: 'commit' },
      ],
      dom: [
        { id: 'dom-2', tagName: 'div.profile', content: '', isNew: false, isUpdated: true, isRemoved: false },
        { id: 'dom-3', tagName: 'h1', content: 'Alice', isNew: true, isUpdated: false, isRemoved: false },
        { id: 'dom-4', tagName: 'p', content: 'Renders: 2', isNew: true, isUpdated: false, isRemoved: false },
      ],
      activePhaseSegment: 'update',
      output: [
...
React compares dependencies using Object.is() - similar to ===. For objects/arrays, this means reference equality. That's why [user] triggered (new object), but [userId] didn't (same string).`,
    ...
    state: {
      component: {
        ...
        effects: [
          { id: 'effect-1', name: 'fetchEffect', dependencies: ['userId'], hasCleanup: true, status: 'complete', runCount: 1 },
          { id: 'effect-2', name: 'titleEffect', dependencies: ['user'], hasCleanup: true, status: 'running', runCount: 2 },
        ],
        renderCount: 2,
        isMounted: true,
        isHighlighted: true,
      ...
      timeline: [
        { id: 'event-7', phase: 'update', stage: 'commit-dom', description: 'DOM updated', timestamp: Date.now() - 100, isActive: false, category: 'commit' },
        { id: 'event-8', phase: 'update', stage: 'cleanup-effects', description: 'titleEffect cleanup', timestamp: Date.now() - 50, isActive: false, category: 'cleanup' },
        { id: 'event-9', phase: 'update', stage: 'run-effects', description: 'titleEffect running', timestamp: Date.now(), isActive: true, category: 'effect' },
      ],
      dom: [
        { id: 'dom-2', tagName: 'div.profile', content: '', isNew: false, isUpdated: false, isRemoved: false },
        { id: 'dom-3', tagName: 'h1', content: 'Alice', isNew: false, isUpdated: false, isRemoved: false },
        { id: 'dom-4', tagName: 'p', content: 'Renders: 2', isNew: false, isUpdated: false, isRemoved: false },
      ],
      activePhaseSegment: 'update',
      output: [
...
This is why cleanup is essential - without it, your effects would keep running even after the component is removed!`,
    ...
    state: {
      component: {
        ...
        props: [{ id: 'userId', name: 'userId', value: '123', hasChanged: false }],
        effects: [
          { id: 'effect-1', name: 'fetchEffect', dependencies: ['userId'], hasCleanup: true, status: 'cleanup', runCount: 1 },
          { id: 'effect-2', name: 'titleEffect', dependencies: ['user'], hasCleanup: true, status: 'cleanup', runCount: 2 },
        ],
        renderCount: 2,
        isMounted: false,
        isHighlighted: true,
      ...
      timeline: [
        { id: 'event-10', phase: 'unmount', stage: 'trigger', description: 'Unmount triggered', timestamp: Date.now() - 100, isActive: false, category: 'render' },
        { id: 'event-11', phase: 'unmount', stage: 'cleanup-effects', description: 'All cleanups running', timestamp: Date.now(), isActive: true, category: 'cleanup' },
      ],
      dom: [
        { id: 'dom-2', tagName: 'div.profile', content: '', isNew: false, isUpdated: false, isRemoved: true },
        { id: 'dom-3', tagName: 'h1', content: 'Alice', isNew: false, isUpdated: false, isRemoved: true },
        { id: 'dom-4', tagName: 'p', content: 'Renders: 2', isNew: false, isUpdated: false, isRemoved: true },
      ],
...
This lifecycle model is the foundation of React - understanding it helps you write bug-free, performant components!`,
    ...
    state: {
      ...
      timeline: [
        { id: 'event-1', phase: 'mount', stage: 'initial-render', description: 'Initial render', timestamp: Date.now() - 600, isActive: false, category: 'render' },
        { id: 'event-2', phase: 'mount', stage: 'commit-dom', description: 'DOM created', timestamp: Date.now() - 500, isActive: false, category: 'commit' },
        { id: 'event-3', phase: 'mount', stage: 'run-effects', description: 'Effects run', timestamp: Date.now() - 400, isActive: false, category: 'effect' },
        { id: 'event-4', phase: 'update', stage: 'trigger', description: 'State update', timestamp: Date.now() - 300, isActive: false, category: 'render' },
        { id: 'event-5', phase: 'update', stage: 'commit-dom', description: 'DOM updated', timestamp: Date.now() - 200, isActive: false, category: 'commit' },
        { id: 'event-6', phase: 'unmount', stage: 'cleanup-effects', description: 'Cleanup', timestamp: Date.now() - 100, isActive: false, category: 'cleanup' },
        { id: 'event-7', phase: 'unmount', stage: 'unmount-complete', description: 'Unmounted', timestamp: Date.now(), isActive: true, category: 'cleanup' },
      ],
      dom: [],
      activePhaseSegment: 'mount',
      output: [
        { id: 'msg-1', type: 'info', message: 'Lifecycle complete: Mount → Update → Unmount' },
        { id: 'msg-2', type: 'info', message: 'Next: Reconciliation - how React diffs Virtual DOM!' },
      ],
      showDiagram: true,
      activePanel: 'diagram',
    },
