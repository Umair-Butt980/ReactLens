...
Without these heuristics, comparing two trees would be O(n³) - impossibly slow for real apps. Let's see how this works in practice...`,
    ...
    state: {
      oldTree: {
        ...
        children: [
          { id: 'old-h1', type: 'h1', props: {}, children: [], key: null, isHighlighted: false, diffStatus: 'unchanged' },
          {
            id: 'old-ul',
            type: 'ul',
            props: {},
            children: [
              { id: 'old-a', type: 'li', props: { key: 'a' }, children: [], key: 'a', isHighlighted: false, diffStatus: 'unchanged' },
              { id: 'old-b', type: 'li', props: { key: 'b' }, children: [], key: 'b', isHighlighted: false, diffStatus: 'unchanged' },
              { id: 'old-c', type: 'li', props: { key: 'c' }, children: [], key: 'c', isHighlighted: false, diffStatus: 'unchanged' },
            ],
            key: null,
            isHighlighted: false,
...
The diffing algorithm will walk these trees and identify exactly what needs to change. Let's start the comparison...`,
    ...
    state: {
      ...
      newTree: {
        ...
        children: [
          { id: 'new-h1', type: 'h1', props: {}, children: [], key: null, isHighlighted: false, diffStatus: 'unchanged' },
          {
            id: 'new-ul',
            type: 'ul',
            props: {},
            children: [
              { id: 'new-c', type: 'li', props: { key: 'c' }, children: [], key: 'c', isHighlighted: false, diffStatus: 'unchanged' },
              { id: 'new-a', type: 'li', props: { key: 'a' }, children: [], key: 'a', isHighlighted: false, diffStatus: 'unchanged' },
              { id: 'new-b', type: 'li', props: { key: 'b' }, children: [], key: 'b', isHighlighted: false, diffStatus: 'unchanged' },
              { id: 'new-d', type: 'li', props: { key: 'd' }, children: [], key: 'd', isHighlighted: false, diffStatus: 'added' },
            ],
            key: null,
            isHighlighted: false,
            diffStatus: 'unchanged',
...
By reusing the DOM node, React only needs to update what actually changed. Let's see what changed in the props...`,
    ...
    state: {
      ...
      phase: 'compare-root',
      comparisonSteps: [
        { id: 'step-1', oldNodeId: 'old-root', newNodeId: 'new-root', result: 'update-props', description: 'Types match (div), comparing props', isActive: true },
      ],
      output: [
      ...
      diffResults: [
        {
          ...
          action: 'update-props',
          nodePath: 'root',
          propChanges: [{ name: 'className', oldValue: 'container', newValue: 'container active', changeType: 'changed' }],
          isActive: true,
        },
      ],
      currentComparison: 'root.props',
      domOperations: [
        { id: 'op-1', type: 'updateAttribute', target: 'div', details: 'className: "container" → "container active"', isExecuted: false, isHighlighted: true },
      ],
      listReconciliation: null,
      phase: 'compare-props',
      comparisonSteps: [
        { id: 'step-1', oldNodeId: 'old-root', newNodeId: 'new-root', result: 'update-props', description: 'className changed', isActive: true },
      ],
      output: [
...
This would be terrible - React would update every single item! Let's see how keys help...`,
    ...
    state: {
      oldTree: {
        ...
        props: { className: 'container' },
        children: [
          { id: 'old-h1', type: 'h1', props: {}, children: [], key: null, isHighlighted: true, diffStatus: 'unchanged' },
          {
            id: 'old-ul',
            type: 'ul',
            props: {},
      ...
      newTree: {
        ...
        props: { className: 'container active' },
        children: [
          { id: 'new-h1', type: 'h1', props: {}, children: [], key: null, isHighlighted: true, diffStatus: 'unchanged' },
          {
            id: 'new-ul',
            type: 'ul',
            props: {},
      ...
      domOperations: [
        { id: 'op-1', type: 'updateAttribute', target: 'div', details: 'className updated', isExecuted: false, isHighlighted: false },
      ],
      listReconciliation: null,
      phase: 'compare-children',
      comparisonSteps: [
        { id: 'step-1', oldNodeId: 'old-root', newNodeId: 'new-root', result: 'update-props', description: 'className changed', isActive: false },
        { id: 'step-2', oldNodeId: 'old-h1', newNodeId: 'new-h1', result: 'none', description: '<h1> unchanged - skip!', isActive: true },
        { id: 'step-3', oldNodeId: 'old-ul', newNodeId: 'new-ul', result: 'none', description: '<ul> same type, checking children...', isActive: true },
      ],
      output: [
...
Every item appears "changed" even though they just moved!`,
    ...
    state: {
      oldTree: {
        ...
        children: [
          { id: 'old-h1', type: 'h1', props: {}, children: [], key: null, isHighlighted: false, diffStatus: 'unchanged' },
          {
            ...
            props: {},
            children: [
              { id: 'old-a', type: 'li', props: { key: 'a' }, children: [], key: 'a', isHighlighted: true, diffStatus: 'reordered' },
              { id: 'old-b', type: 'li', props: { key: 'b' }, children: [], key: 'b', isHighlighted: true, diffStatus: 'reordered' },
              { id: 'old-c', type: 'li', props: { key: 'c' }, children: [], key: 'c', isHighlighted: true, diffStatus: 'reordered' },
            ],
            key: null,
            isHighlighted: true,
            diffStatus: 'unchanged',
      ...
      newTree: {
        ...
        children: [
          { id: 'new-h1', type: 'h1', props: {}, children: [], key: null, isHighlighted: false, diffStatus: 'unchanged' },
          {
            ...
            props: {},
            children: [
              { id: 'new-c', type: 'li', props: { key: 'c' }, children: [], key: 'c', isHighlighted: true, diffStatus: 'reordered' },
              { id: 'new-a', type: 'li', props: { key: 'a' }, children: [], key: 'a', isHighlighted: true, diffStatus: 'reordered' },
              { id: 'new-b', type: 'li', props: { key: 'b' }, children: [], key: 'b', isHighlighted: true, diffStatus: 'reordered' },
              { id: 'new-d', type: 'li', props: { key: 'd' }, children: [], key: 'd', isHighlighted: true, diffStatus: 'added' },
            ],
            key: null,
            isHighlighted: true,
            diffStatus: 'unchanged',
      ...
      listReconciliation: {
        ...
        operations: ['Move c to index 0', 'Move a to index 1', 'Move b to index 2', 'Insert d at index 3'],
      },
      phase: 'key-matching',
      comparisonSteps: [],
      output: [
...
Let's execute these operations and see the final result...`,
    ...
    state: {
      oldTree: {
        ...
        children: [
          { id: 'old-h1', type: 'h1', props: {}, children: [], key: null, isHighlighted: false, diffStatus: 'unchanged' },
          {
            ...
            props: {},
            children: [
              { id: 'old-a', type: 'li', props: { key: 'a' }, children: [], key: 'a', isHighlighted: false, diffStatus: 'reordered' },
              { id: 'old-b', type: 'li', props: { key: 'b' }, children: [], key: 'b', isHighlighted: false, diffStatus: 'reordered' },
              { id: 'old-c', type: 'li', props: { key: 'c' }, children: [], key: 'c', isHighlighted: false, diffStatus: 'reordered' },
            ],
            key: null,
            isHighlighted: false,
            diffStatus: 'unchanged',
      ...
      newTree: {
        ...
        children: [
          { id: 'new-h1', type: 'h1', props: {}, children: [], key: null, isHighlighted: false, diffStatus: 'unchanged' },
          {
            ...
            props: {},
            children: [
              { id: 'new-c', type: 'li', props: { key: 'c' }, children: [], key: 'c', isHighlighted: false, diffStatus: 'reordered' },
              { id: 'new-a', type: 'li', props: { key: 'a' }, children: [], key: 'a', isHighlighted: false, diffStatus: 'reordered' },
              { id: 'new-b', type: 'li', props: { key: 'b' }, children: [], key: 'b', isHighlighted: false, diffStatus: 'reordered' },
              { id: 'new-d', type: 'li', props: { key: 'd' }, children: [], key: 'd', isHighlighted: false, diffStatus: 'added' },
            ],
            key: null,
            isHighlighted: false,
      ...
      currentComparison: null,
      domOperations: [
        { id: 'op-1', type: 'updateAttribute', target: 'div', details: 'className → "container active"', isExecuted: false, isHighlighted: true },
        { id: 'op-2', type: 'insertChild', target: 'ul', details: 'Create and insert <li key="d">Date</li>', isExecuted: false, isHighlighted: true },
        { id: 'op-3', type: 'insertChild', target: 'ul', details: 'Move <li key="c"> to position 0', isExecuted: false, isHighlighted: true },
        { id: 'op-4', type: 'insertChild', target: 'ul', details: 'Move <li key="a"> to position 1', isExecuted: false, isHighlighted: true },
      ],
      listReconciliation: {
        oldKeys: ['a', 'b', 'c'],
        newKeys: ['c', 'a', 'b', 'd'],
...
After commit, effects run (if any). Our reconciliation is complete!`,
    ...
    state: {
        ...
        children: [
          { id: 'new-h1', type: 'h1', props: {}, children: [], key: null, isHighlighted: false, diffStatus: 'unchanged' },
          {
            ...
            children: [
              ...
              { id: 'new-a', type: 'li', props: { key: 'a' }, children: [], key: 'a', isHighlighted: false, diffStatus: 'unchanged' },
              { id: 'new-b', type: 'li', props: { key: 'b' }, children: [], key: 'b', isHighlighted: false, diffStatus: 'unchanged' },
              { id: 'new-d', type: 'li', props: { key: 'd' }, children: [], key: 'd', isHighlighted: false, diffStatus: 'unchanged' },
            ],
            key: null,
            isHighlighted: false,
            diffStatus: 'unchanged',
      ...
      currentComparison: null,
      domOperations: [
        { id: 'op-1', type: 'updateAttribute', target: 'div', details: 'className → "container active"', isExecuted: true, isHighlighted: false },
        { id: 'op-2', type: 'insertChild', target: 'ul', details: 'Create <li key="d">Date</li>', isExecuted: true, isHighlighted: false },
        { id: 'op-3', type: 'insertChild', target: 'ul', details: 'Move <li key="c"> to position 0', isExecuted: true, isHighlighted: false },
        { id: 'op-4', type: 'insertChild', target: 'ul', details: 'Move <li key="a"> to position 1', isExecuted: true, isHighlighted: false },
      ],
      listReconciliation: null,
      phase: 'complete',
      comparisonSteps: [],
...
Understanding reconciliation helps you write performant React apps!`,
    ...
    state: {
      oldTree: {
        ...
        children: [
          { id: 'old-h1', type: 'h1', props: {}, children: [], key: null, isHighlighted: true, diffStatus: 'unchanged' },
          {
            ...
            props: {},
            children: [
              { id: 'old-a', type: 'li', props: { key: 'a' }, children: [], key: 'a', isHighlighted: true, diffStatus: 'unchanged' },
              { id: 'old-b', type: 'li', props: { key: 'b' }, children: [], key: 'b', isHighlighted: true, diffStatus: 'unchanged' },
              { id: 'old-c', type: 'li', props: { key: 'c' }, children: [], key: 'c', isHighlighted: true, diffStatus: 'unchanged' },
            ],
            key: null,
            isHighlighted: true,
            diffStatus: 'unchanged',
      ...
      newTree: {
        ...
        children: [
          { id: 'new-h1', type: 'h1', props: {}, children: [], key: null, isHighlighted: true, diffStatus: 'unchanged' },
          {
            ...
            props: {},
            children: [
              { id: 'new-c', type: 'li', props: { key: 'c' }, children: [], key: 'c', isHighlighted: true, diffStatus: 'unchanged' },
              { id: 'new-a', type: 'li', props: { key: 'a' }, children: [], key: 'a', isHighlighted: true, diffStatus: 'unchanged' },
              { id: 'new-b', type: 'li', props: { key: 'b' }, children: [], key: 'b', isHighlighted: true, diffStatus: 'unchanged' },
              { id: 'new-d', type: 'li', props: { key: 'd' }, children: [], key: 'd', isHighlighted: true, diffStatus: 'unchanged' },
            ],
            key: null,
            isHighlighted: true,
            diffStatus: 'unchanged',
      ...
      comparisonSteps: [],
      output: [
        { id: 'msg-1', type: 'info', message: 'Reconciliation: Old VDOM → New VDOM → Minimal DOM ops' },
        { id: 'msg-2', type: 'info', message: 'Next: React Fiber - enabling concurrent rendering!' },
      ],
      activePanel: 'trees',
      showConnections: true,
    },
