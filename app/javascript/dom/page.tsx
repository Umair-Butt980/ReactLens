...
import { DOMVisual } from '@/components/visualizations';
import { domCode, domSteps, domKeyTakeaways } from '@/lib/data/dom-steps';
...
export default function DOMPage() {
  ...
  const totalSteps = domSteps.length;
  const currentStepData = domSteps[currentStep - 1];
  ...
  return (
    <div className="bg-background flex min-h-screen flex-col">
      ...
      <ConceptHeader
        ...
        backHref="/javascript"
        prevTopic={{ title: 'Closures', href: '/javascript/closures' }}
        nextTopic={{ title: 'Virtual DOM', href: '/javascript/virtual-dom' }}
      />
        ...
        <SplitView
          animationPanel={
            <AnimationPanelWrapper title="Visualization">
              <DOMVisual state={currentStepData.animationState} />
            </AnimationPanelWrapper>
          }
          codePanel={
            <CodePanel
      ...
      <ExplanationPanel
        ...
        controls={
          <div className="flex w-full flex-col items-center gap-6">
            ...
            {currentStep === totalSteps && (
              <KeyTakeaways takeaways={domKeyTakeaways} className="w-full max-w-xl" />
            )}
          </div>
        }
      />
