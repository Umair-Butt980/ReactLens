    ...
    <div className="bg-background flex min-h-screen flex-col">
      ...
      <header className="border-border/40 bg-background/80 sticky top-0 z-50 w-full border-b backdrop-blur-xl">
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          ...
          <h1 className="text-foreground text-lg font-bold tracking-tight">Hoisting</h1>
          <div className="w-20" />
        </div>
      </header>
      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-6 p-8">
        ...
        >
          <div className="rounded-2xl bg-orange-500/20 p-6">
            <Construction className="h-12 w-12 text-orange-400" aria-hidden="true" />
          </div>
          <h2 className="text-foreground text-2xl font-bold">Coming Soon</h2>
          <p className="text-muted-foreground max-w-md">
            The Hoisting visualization will demonstrate how JavaScript moves variable and function
            declarations to the top during the creation phase.
          </p>
          <Link
