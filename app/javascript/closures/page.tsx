...
import { ClosureVisual } from '@/components/visualizations/javascript';
import { closureSteps, closureCode, closureKeyTakeaways } from '@/lib/data';
  ...
  return (
    <div className="bg-background flex min-h-screen flex-col">
      ...
      <ConceptHeader
        ...
        backHref="/javascript"
        prevTopic={{ title: 'Hoisting', href: '/javascript/hoisting' }}
      ...
      <ExplanationPanel
        ...
        controls={
          <div className="flex w-full flex-col items-center gap-6">
            ...
            {currentStep === totalSteps && (
              <KeyTakeaways takeaways={closureKeyTakeaways} className="w-full max-w-xl" />
            )}
          </div>
        }
      />
