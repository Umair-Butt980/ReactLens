...
import { CallStackVisual } from '@/components/visualizations/javascript';
import { callStackSteps, callStackCode, callStackKeyTakeaways } from '@/lib/data';
...
export default function CallStackPage() {
  ...
  const totalSteps = callStackSteps.length;
  const currentStepData = callStackSteps[currentStep - 1];
  ...
  return (
    <div className="bg-background flex min-h-screen flex-col">
      ...
      <ConceptHeader
        ...
        backHref="/javascript"
        prevTopic={{ title: 'Event Loop', href: '/javascript/event-loop' }}
        nextTopic={{ title: 'Hoisting', href: '/javascript/hoisting' }}
      />
        ...
        <SplitView
          animationPanel={
            <AnimationPanelWrapper title="Visualization">
              <CallStackVisual state={currentStepData.state} />
            </AnimationPanelWrapper>
          }
          codePanel={
            <CodePanel
      ...
      <ExplanationPanel
        ...
        controls={
          <div className="flex w-full flex-col items-center gap-6">
            ...
            {currentStep === totalSteps && (
              <KeyTakeaways takeaways={callStackKeyTakeaways} className="w-full max-w-xl" />
            )}
          </div>
        }
      />
