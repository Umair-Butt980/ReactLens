...
import { EventLoopVisual } from '@/components/visualizations';
import { eventLoopCode, eventLoopSteps, eventLoopKeyTakeaways } from '@/lib/data/event-loop-steps';
...
export default function EventLoopPage() {
  ...
  const currentStepData = eventLoopSteps[currentStep - 1];
        ...
        <SplitView
          animationPanel={
            <AnimationPanelWrapper title="Visualization">
              <EventLoopVisual state={currentStepData.state} />
            </AnimationPanelWrapper>
          }
          codePanel={
            <CodePanel
      ...
      <ExplanationPanel
        ...
        controls={
          <div className="flex w-full flex-col items-center gap-6">
            ...
            {currentStep === totalSteps && (
              <KeyTakeaways takeaways={eventLoopKeyTakeaways} className="w-full max-w-xl" />
            )}
          </div>
        }
      />
