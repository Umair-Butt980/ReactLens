...
import { PropsStateVisual } from '@/components/visualizations/react';
import { propsStateSteps, propsStateCode, propsStateKeyTakeaways } from '@/lib/data';
...
export default function PropsStatePage() {
  ...
  const totalSteps = propsStateSteps.length;
  const currentStepData = propsStateSteps[currentStep - 1];
  ...
  return (
    <div className="bg-background flex min-h-screen flex-col">
      ...
      <ConceptHeader
        ...
        backHref="/react"
        prevTopic={{ title: 'JSX & Components', href: '/react/jsx-components' }}
        nextTopic={{ title: 'React Hooks', href: '/react/hooks' }}
      />
      ...
      <div className="flex-1 overflow-hidden">
        <SplitView
          animationPanel={
            <AnimationPanelWrapper title="Data Flow Visualization">
              <VisualizationErrorBoundary visualizationName="Props & State">
                <PropsStateVisual state={currentStepData.state} />
      ...
      <ExplanationPanel
        ...
        controls={
          <div className="flex w-full flex-col items-center gap-6">
            ...
            {currentStep === totalSteps && (
              <KeyTakeaways takeaways={propsStateKeyTakeaways} className="w-full max-w-xl" />
            )}
          </div>
        }
      />
