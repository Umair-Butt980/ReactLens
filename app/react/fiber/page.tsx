...
import { FiberVisual } from '@/components/visualizations/react';
import { fiberSteps, fiberCode, fiberKeyTakeaways } from '@/lib/data';
...
export default function FiberPage() {
  ...
  const totalSteps = fiberSteps.length;
  const currentStepData = fiberSteps[currentStep - 1];
  ...
  return (
    <div className="bg-background flex min-h-screen flex-col">
      ...
      <ConceptHeader
        ...
        backHref="/react"
        prevTopic={{ title: 'Reconciliation', href: '/react/reconciliation' }}
      />
      ...
      <div className="flex-1 overflow-hidden">
        <SplitView
          animationPanel={
            <AnimationPanelWrapper title="Fiber Architecture">
              <VisualizationErrorBoundary visualizationName="React Fiber">
                <FiberVisual state={currentStepData.state} />
      ...
      <ExplanationPanel
        ...
        controls={
          <div className="flex w-full flex-col items-center gap-6">
            ...
            {currentStep === totalSteps && (
              <KeyTakeaways takeaways={fiberKeyTakeaways} className="w-full max-w-xl" />
            )}
          </div>
        }
      />
