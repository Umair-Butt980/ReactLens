...
import { HooksVisual } from '@/components/visualizations/react';
import { hooksSteps, hooksCode, hooksKeyTakeaways } from '@/lib/data';
...
export default function HooksPage() {
  ...
  const totalSteps = hooksSteps.length;
  const currentStepData = hooksSteps[currentStep - 1];
  ...
  return (
    <div className="bg-background flex min-h-screen flex-col">
      ...
      <ConceptHeader
        ...
        backHref="/react"
        prevTopic={{ title: 'Props & State', href: '/react/props-state' }}
        nextTopic={{ title: 'Component Lifecycle', href: '/react/lifecycle' }}
      />
      ...
      <div className="flex-1 overflow-hidden">
        <SplitView
          animationPanel={
            <AnimationPanelWrapper title="Hooks Internals">
              <VisualizationErrorBoundary visualizationName="React Hooks">
                <HooksVisual state={currentStepData.state} />
      ...
      <ExplanationPanel
        ...
        controls={
          <div className="flex w-full flex-col items-center gap-6">
            ...
            {currentStep === totalSteps && (
              <KeyTakeaways takeaways={hooksKeyTakeaways} className="w-full max-w-xl" />
            )}
          </div>
        }
      />
